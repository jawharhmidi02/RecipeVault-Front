...
const RecipeCard = ({ recipe }) => {
  ...
  return (
    <div className="flex   flex-col gap-2 rounded-xl bg-white shadow-md transition-all duration-200 hover:scale-[1.03] hover:cursor-pointer">
      <div className="relative overflow-hidden rounded-t-xl">
        ...
        <div className="absolute bottom-2 right-3 flex flex-row items-center justify-center gap-1 rounded-xl bg-white px-2 py-[3px]">
          <svg
            ...
            className="size-5 transition-all duration-50 opacity-100 z-10 peer hover:opacity-0"
            viewBox="0 0 512 512"
          >
            <path
              fill="black"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="size-5 absolute opacity-0 transition-all duration-50 peer peer-hover:opacity-100 -left-[-8px]" viewBox="0 0 512 512">
            <path
              fill="#ff8787"
      ...
      <div className="gap-2 flex flex-col px-6 pb-4 pt-2">
        <div className="text-[22px] font-bold break-all">{recipe.name}</div>
        <div>
