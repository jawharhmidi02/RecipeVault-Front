...
const page = () => {
  ...
  const handleSendMessage = () => {
    ...
    else if(emailInput.current.value.trim() == "" || !validateEmail(emailInput.current.value.trim())){
      toast({
      ...
      <div className="mx-5 flex w-full max-w-[1300px] flex-col gap-20 sm:mx-10 xl:mx-28">
        ...
        <div className="flex flex-col gap-8">     
          ...
          <div className="flex flex-col gap-4 rounded-sm border-[1px] border-neutral-100 bg-white p-4 shadow-sm drop-shadow-sm">
            ...
            ></textarea>
            <span className="font-light text-neutral-700 text-[12px] text-end">500 Chars max</span>
            <button
